    ...
    return (
      ...
      >
        <input
          ...
          type={type}
          className={cn(
            `text-sans-md text-default bg-default placeholder:text-quaternary disabled:text-tertiary disabled:bg-disabled w-full rounded border-none px-3 py-[0.6875rem] !outline-offset-1 focus:outline-none disabled:cursor-not-allowed`,
